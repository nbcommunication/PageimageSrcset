...
### Image Suffix
You will see this field when Remove Variations is checked. The value is appended to the name of the images generated by this module and is used to remove old variations if the set rules change. You should not encounter any issues with the default suffix, but if you find that it conflicts with any other functionality on your site, you can set a custom suffix instead.
